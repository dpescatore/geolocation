...
//creazione di un quarto layer contenente il tile per bing
var tileBing = new ol.layer.Tile({
    visible: false,
    preload: Infinity,
    source: new ol.source.BingMaps({
        //CREATE YOUR OWN KEY AT https://www.bingmapsportal.com
        key: 'AuZetjb_Ei_LKnuU63FR77H7C8bP6M88-V9wHIoWMaweHUbHXh-7mrZKsWbG1rwa',
        imagerySet: 'Aerial'
    })
});
...
layers = [
    raster, vector, vectorNation, tileBing
];
